...
const loadQuestion = async (question, init) => {
    ...
    else if(question.correct == question.answers[2]) {
        crr_ans = "67";
    }
    else if(question.correct == question.answers[3]) {
        crr_ans = "68";
    }
    else if(question.correct == question.answers[4]) {
        crr_ans = "69";
    }
    else if(question.correct == question.answers[5]) {
        crr_ans = "70";
    }
...
const storeAnswers = (add, key) => {
    ...
    ans = quiz.questions[currentQuestionIndex].entered;
}
